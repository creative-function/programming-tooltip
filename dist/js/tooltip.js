...
var Tooltip = function Tooltip(className, hoverText, overrideOptions, requiredOptions) {
  ...
  $linkEl.addEventListener("mouseout", hideTooltip()); //object.assign takes given paramerters and merges them into new paramaters, going in order. The last parameter will always be "required options" as they will be passed last 
